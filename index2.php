  ...
  <main>
    <section
      ...
      <div class="container mx-auto text-left px-4 pl-24">
        ...
        <a
          ...
          class="bg-white/60 px-6 py-2 rounded font-bold hover:bg-gray-200 text-white">Konsultasikan Sekarang!</a>
      </div>
    </section>
    ...
    <section id="tentang-kami" class="mx-20 mt-8 flex gap-20">
      ...
      <div class="w-full bg-white rounded-2xl shadow-xl">
        <img src="image/about.png" class="p-8" />
      </div>
    </section>
    ...
    <section
      ...
      <div class="w-50% bg-white/10% rounded-2xl shadow-xl">
        <img src="image/about.png" class="p-8" />
      </div>
          ...
          <div class="swiper-wrapper pb-4">
            <?php if ($result->num_rows > 0): ?>
              <?php while ($row = $result->fetch_assoc()): ?>
                <div
                  class="swiper-slide w-[341px] h-[152px] bg-white p-2 rounded-lg shadow-lg">
                  <div class="flex items-center gap-4">
                    <img src="image/Profile.png" alt="" />
                    <div class="">
                      <h5 class="text-xl font-bold text-black"><?= htmlspecialchars($row['name']) ?></h5>

                    </div>
                    <div class="flex ml-auto">
                      <?php for ($i = 0; $i < 5; $i++): ?>
                        <img
                          src="image/<?= $i < $row['rate'] ? 'Star.png' : 'Star-empty.png' ?>"
                          alt="Star"
                          class="w-5 h-5" />
                      <?php endfor; ?>
                    </div>
